            ...
            <div class="modal fade" id="noticia10" role="dialog">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <time>15/11/2015 08:44:15</time>
                            <p>Autor: Alexia Paza</p>
                            <p>Os cursos do senai ofertados</p>
                            <p>Os cursos do senai ofertados</p>
                            <p>Os cursos do senai ofertados</p>
...
<div class="col-md-4">
            ...
            <!-- Trigger the modal with a button -->
            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#noticia2">Leia Mais...</button>
            ...
            <!-- Trigger the modal with a button -->
            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#noticia3">Leia Mais...</button>
